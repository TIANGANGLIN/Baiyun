...
# print("reg_12",type(reg_12))
# print("grid_search_12",type(grid_search_12))
print(x_train_sta.shape,type(x_train_sta),type(np.array(x_train_sta)))
print(y_train_sta.shape,type(y_train_sta))
grid_search_12.fit(x_train_sta, y_train_sta)
